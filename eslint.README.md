# ESLint
## What is ESLint?
Linting is the automated process of checking source code for errors, bugs, and stylistic issues using a tool called linter.
Then, ESLint is an open-source `JavaScript` linting utility developed in 2013. It is frequently used to find problematic patterns or code that doesn't adhere to certain style guidelines. ESLint is written using Node.js to provide a fast runtime environment and easy installation via npm. With ESLint you can impose the coding standard using a certain set of standlaone rules. You can turn those rules on and offm and these rules are completely pluggable.
